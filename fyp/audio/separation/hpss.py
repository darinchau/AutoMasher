...
from .. import Audio, HPSSCollection
import torch
import librosa


class HPSSAudioSeparator:
    ...
    def separate(self, audio: Audio) -> HPSSCollection:
        ...
        if not self._return_harmonic and not self._return_percussive:
            return HPSSCollection(None, None)
        ...
        return HPSSCollection(
            ...
            percussive=result.get('percussive')
        )
